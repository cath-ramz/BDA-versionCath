...
CREATE OR REPLACE PROCEDURE productoActualizar(
    ...
    IN kilatajeSP           VARCHAR(10),   -- AHORA VARCHAR
    IN leySP                VARCHAR(10)    -- CAMBIADO A VARCHAR TAMBIÉN
)
BEGIN
    DECLARE IDsku INT;
    DECLARE IDproducto INT;
    ...
    ELSE
        ...
        -- Opcional: validar que solo sean dígitos
    ...
    ELSE
        ...
        -- Permitir coma decimal (ej. '0,925')
    ...
    -- Oro / kilataje
    -- ===========================
    IF v_kilataje IS NOT NULL THEN
